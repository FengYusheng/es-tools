...
def derivation():
    ...
    records = add_new_analyzer_results(records, './data/derivation_ar_std_lem_report.csv', 'ar_std_lem')
...
def derivation_for_inaccuracy():
    ...
    records = add_new_analyzer_results(records, './data/derivation2_rbl_ara_report.csv', 'rbl_ara')
