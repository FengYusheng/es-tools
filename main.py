...
def regular_verbs():
    ...
    process_inflection_in_a_csv_file('./data/regular_verbs.csv', analyzer='ara_hunspell')
    # process_inflection_in_a_csv_file('./data/regular_verbs.csv', analyzer='msarhan')
    records = collect_analyzer_results('./data/regular_verbs_ara_hunspell_report.csv', 'ara_hunspell')
...
def irregular_verbs():
    ...
    process_inflection_in_a_csv_file('./data/irregular_verbs.csv', analyzer='ara_hunspell')
    # process_inflection_in_a_csv_file('./data/irregular_verbs.csv', analyzer='msarhan')
    records = collect_analyzer_results('./data/irregular_verbs_ara_hunspell_report.csv', 'ara_hunspell')
...
def nouns():
    ...
    process_inflection_in_a_csv_file('./data/nouns.csv', analyzer='ara_hunspell')
    # process_inflection_in_a_csv_file('./data/nouns.csv', analyzer='msarhan')
    records = collect_analyzer_results('./data/nouns_ara_hunspell_report.csv', 'ara_hunspell')
...
def numerals():
    ...
    process_inflection_in_a_csv_file('./data/numerals.csv', analyzer='ara_hunspell')
    # process_inflection_in_a_csv_file('./data/numerals.csv', analyzer='msarhan')
    records = collect_analyzer_results('./data/numerals_ara_hunspell_report.csv', 'ara_hunspell')
...
def derivation():
    ...
    process_inflection_in_a_csv_file('./data/derivation.csv', analyzer='ara_hunspell')
    # process_inflection_in_a_csv_file('./data/derivation.csv', analyzer='msarhan')
    records = collect_analyzer_results('./data/derivation_ara_hunspell_report.csv', 'ara_hunspell')
...
def derivation_for_inaccuracy():
    ...
    process_inflection_in_a_csv_file('./data/derivation2.csv', analyzer='ara_hunspell')
    # process_inflection_in_a_csv_file('./data/derivation2.csv', analyzer='msarhan')
    records = collect_analyzer_results('./data/derivation2_ara_hunspell_report.csv', 'ara_hunspell')
